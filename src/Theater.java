...
public class Theater
{
    ...
    //Semaphores
    static Queue<Customer> queueBoxOfficeAgent = new LinkedList<Customer>();
    static Queue<Customer> queueTicketTaker = new LinkedList<Customer>();
    static Queue<Customer> queueConcessionStandWorker = new LinkedList<Customer>();
